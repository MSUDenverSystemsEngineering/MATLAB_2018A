...
Try {
	...
	[string]$appVersion = '2018a'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '3.7.0.1'
	[string]$appScriptDate = '07/10/2018'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Copy-item -Path "$dirSupportFiles\license.dat" -Destination "$envProgramFiles\MATLAB\R2018a\license.dat"
		...
		$exitCode = Execute-Process -Path "$dirFiles\R2018a\setup.exe" -Parameters "-inputFile `"$dirSupportFiles\installer_input.txt`" -activationPropertiesFile `"$dirSupportFiles\activate.ini`"" -WindowStyle "Hidden" -PassThru
		...
		Remove-File -Path "$envProgramData\Microsoft\Windows\Start Menu\Programs\MATLAB R2018a\Activate MATLAB R2018a.lnk"
		Remove-File -Path "$envProgramData\Microsoft\Windows\Start Menu\Programs\MATLAB R2018a\Deactivate MATLAB R2018a.lnk"
		Execute-Process -Path "$envSystem32Directory\netsh.exe" -Parameters "advfirewall firewall add rule name=`"MATLAB R2018a`" dir=in action=allow program=`"C:\program files\matlab\r2018a\bin\win64\matlab.exe`" description=`"MATLAB R2018a`" enable=yes profile=any protocol=tcp edge=deferuser" -WindowStyle "Hidden"
		Execute-Process -Path "$envSystem32Directory\netsh.exe" -Parameters "advfirewall firewall add rule name=`"MATLAB R2018a`" dir=in action=allow program=`"C:\program files\matlab\r2018a\bin\win64\matlab.exe`" description=`"MATLAB R2018a`" enable=yes profile=any protocol=udp edge=deferuser" -WindowStyle "Hidden"
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		$exitCode = Execute-Process -Path "$envProgramFiles\MATLAB\R2018a\uninstall\bin\win64\uninstall.exe" -Parameters "-inputFile `"$dirSupportFiles\uninstaller_input.txt`"" -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD1Vw4pe3HFztol
# HolHqTazFj19ipO3gx95gbemMfyRu6CCGdcwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# BDEiBCBU+7nf9sS64zX6HaCK9Kj8fMhABg8OxZZY+8VeWTozjjANBgkqhkiG9w0B
# AQEFAASCAQAa1JC6vU4ruMc8I2QEjRaokUnSdrREHyFh6Ib+NKRvnDNWRsTczMp2
# p7TxPBgUX2wBNsItkJhNM+1tN7D9wtA9aGgwZPxvjHCbAxw5MuLLdiAL5l8xJIEQ
# EbHw5kVkHZFbcwSB4WJdIEZ5sOrP7Zrcx3IYSfN+bF8I62gQ+tZ+3A2E4zZ9l4/n
# XrUDANLovC7Skty9YhCkRVqAooVwD4HJ8dsddUtzOQMjSfue7whX+PZgRmNHjqIk
# rnXYk5fc5/NFcQvMD28gz5hBFls8AEMESQCLFRMC1PYfoN8ql/Au/usuJL4auN/y
# aKIF/XHyJXHWO+l2SvFrBg3sOHgCu8YzoYICojCCAp4GCSqGSIb3DQEJBjGCAo8w
# ggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYt
# c2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEh
# 1pmnZJc+8fhCfukZzFNBFDAJBgUrDgMCGgUAoIH9MBgGCSqGSIb3DQEJAzELBgkq
# hkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE4MDcxMTE1MjAxMVowIwYJKoZIhvcN
# AQkEMRYEFNHyB3MSOBuk1vF/1Z82pHTbDBmpMIGdBgsqhkiG9w0BCRACDDGBjTCB
# ijCBhzCBhAQUY7gvq2H1g5CWlQULACScUCkz7HkwbDBWpFQwUjELMAkGA1UEBhMC
# QkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNp
# Z24gVGltZXN0YW1waW5nIENBIC0gRzICEhEh1pmnZJc+8fhCfukZzFNBFDANBgkq
# hkiG9w0BAQEFAASCAQBYg9eRhlrjkPGbqPKUrTt6FQfaoAx5UkShu9Egj86X0/Eq
# UiS5iAPHpH7b9OM7WbyvEyq2LCQETTQb4i1TTqiP2tgHX9FqMyDMBTg4pyjvToYS
# NpIPgi8KTw769TxmfPhTR98iOaE8bPsZUpPsAFSECFRvIAlxusbXWFRsGJpkKDH3
# N1nuLPmX7sKAI4Sq2FQbNvKebGbrLs4z4FuPrRhRelNVgY9S18v+UCoh2ZaYtTFJ
# F2379qdZ3fXKhWCyKaIIMh+h9ZiuyApeqG87gmR3CUTxxGm1fFppYRaAjD2lcASz
# qEjr5wqBdyPAseoEvI309RLBvA7s4ujOd97EKmjZ
